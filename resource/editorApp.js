...
;(function ( $, window, undefined ) {
	...
	WindEditor.initOpenApp[appName](function(item, root_path){
		...
		var editorDoc = _self.editorDoc = _self.iframe[0].contentWindow.document,
			plugin_icon = $('<div class="wind_icon" data-control="'+ appName +'"><span class="'+ appName +'" title="webim" style="background:url('+ root_path +'images/icon.png) no-repeat center center;"></span></div>').appendTo(  _self.pluginsContainer  );
